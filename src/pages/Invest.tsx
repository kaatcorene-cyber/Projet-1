            ...
            >
              <div className="flex items-center gap-4 relative z-10">
                <div className="w-16 h-16 rounded-[14px] overflow-hidden shrink-0 shadow-sm bg-slate-100 relative">
                  ...
                  <img src={plan.image || '/logo_olam.jpg'} alt="Plan" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" referrerPolicy="no-referrer" />
                </div>
