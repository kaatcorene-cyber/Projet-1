...
function CountdownTimer({ activeInvestments, onTickZero }: { activeInvestments: any[], onTickZero: () => void }) {
  ...
  useEffect(() => {
    ...
    const calculateTime = () => {
      ...
      if (shouldTick && now - lastTickTimeRef.current > 15000) {
  ...
  return (
    <div className="bg-[#1a1a1a] rounded-3xl p-6 relative overflow-hidden flex items-center justify-between border border-white/10 shadow-2xl mt-6">
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-amber-500 rounded-full blur-[60px] opacity-20 pointer-events-none"></div>
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-24 font-sans text-gray-100">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
         <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-500/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3"></div>
         <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-amber-600/5 rounded-full blur-[80px] translate-y-1/3 -translate-x-1/3"></div>
