    ...
    <div className="bg-white rounded-[24px] p-5 border border-slate-200 shadow-sm flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
         <div className="flex flex-col bg-slate-50 p-3 rounded-2xl border border-slate-100">
            ...
            <span className="text-emerald-600 font-black text-sm leading-none">{formatCurrency(inv.daily_yield)}</span>
         </div>
         <div className="flex flex-col bg-slate-50 p-3 rounded-2xl border border-slate-100">
      ...
      <div className="pt-2">
        {canClaim ? (
          <button 
            onClick={handleClaim}
            disabled={isClaiming}
            className="w-full py-3.5 rounded-2xl bg-emerald-500 text-white font-black text-sm hover:bg-emerald-400 transition-colors shadow-lg shadow-emerald-500/25 active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2"
          >
          ...
          <div className="w-full flex flex-col gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
            ...
            <div className="w-full bg-slate-200 rounded-full h-2 overflow-hidden shadow-inner">
              <div 
                 className="h-full rounded-full transition-all duration-1000 ease-linear bg-emerald-500 shadow-sm"
