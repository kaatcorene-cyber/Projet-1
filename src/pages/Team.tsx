  ...
  return (
    <div className="min-h-screen bg-transparent p-5 pt-16 pb-24 font-sans">
      <header className="flex justify-between items-center gap-4 pb-4 border-b border-zinc-800/60 mb-6">
        ...
        <img src="https://i.imgur.com/CDLHO6I.png" alt="Logo" className="w-20 h-20 rounded-2xl object-cover shadow-[0_4px_12px_rgba(0,0,0,0.1)] border-2 border-white flex-shrink-0" referrerPolicy="no-referrer" />
      </header>
