    ...
    <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-sm flex flex-col gap-5">
      <div className="flex gap-4 items-center">
         <div className="w-20 h-20 rounded-2xl overflow-hidden flex-shrink-0 relative shadow-inner border border-slate-100">
           <img referrerPolicy="no-referrer" src={plan?.image || "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&q=80&w=800"} alt="Plan" className="w-full h-full object-cover" />
         </div>
      ...
      <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-100">
         <div className="flex flex-col">
            ...
            <span className="text-emerald-600 font-black text-sm">{formatCurrency(inv.daily_yield)}</span>
         </div>
         <div className="flex flex-col">
      ...
      <div className="pt-4 border-t border-slate-100">
        {canClaim ? (
          <button 
            onClick={handleClaim}
            disabled={isClaiming}
            className="w-full py-3.5 rounded-2xl bg-emerald-500 text-white font-black text-sm hover:bg-emerald-400 transition-colors shadow-lg shadow-emerald-500/20 active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2"
          >
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
              <div
                  className="h-full rounded-full transition-all duration-1000 ease-linear bg-emerald-500" 
