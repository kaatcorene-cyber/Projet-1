...
export function History() {
  ...
  const getIconColor = (type: string) => {
    if (type === 'referral_bonus') return 'bg-brand-500/20 text-brand-400';
          ...
          {transactions.map((tx, idx) => (
            ...
            >
              ...
              <div className="text-right">
                <p className={`font-black text-[16px] leading-tight mb-1 ${tx.type === 'withdrawal' || tx.type === 'investment' ? 'text-slate-900' : 'text-brand-400'}`}>
