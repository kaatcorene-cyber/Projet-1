...
import { CircleUser, Users, Wallet, Home } from 'lucide-react';
...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200/60 pb-safe shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.05)]">
